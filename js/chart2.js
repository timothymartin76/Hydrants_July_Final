    ...
    var apiCall = "https://timothymartin76.cartodb.com/api/v2/sql?format=json&q=SELECT date_trunc('day', created_date) AS \"day\" , count(*) AS \"complaints\" FROM homeless_both GROUP BY 1 ORDER BY 1";
    var cartodbData = [];
