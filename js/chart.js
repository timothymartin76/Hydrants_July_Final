    ...
    var apiCall = "https://timothymartin76.cartodb.com/api/v2/sql?format=json&q=SELECT date_trunc('hour', created_date) AS \"hour\" , count(*) AS \"complaints\" FROM hydrants_julyfinal GROUP BY 1 ORDER BY 1";
    var cartodbData = [];
